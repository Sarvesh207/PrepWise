  ...
  return (
    <section className="flex flex-col items-center -mt-18">
      ...
      >
        ...
        <span>See how PrepWise fits your journey.</span>
      </motion.a>
      <motion.h1
      ...
      >
        Track your interview journey, practice with mock interviews, and prepare
        to win — all in one place, with PrepWise.
      </motion.p>
      <motion.div
